...
SELECT e.emp_name, departments.dept_name FROM employees e, departments;
SELECT e.emp_name, departments.dept_name FROM employees e INNER JOIN departments on TRUE;
SELECT e.emp_name, projects.project_name FROM employees e CROSS JOIN projects;
